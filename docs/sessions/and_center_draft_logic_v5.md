# AND Center 자동 포스팅 프롬프트 v5

## v4 → v5 변경 핵심

- 훅 공식 10개 명시
- 참여 유도 장치(Engagement Bait) 추가
- 해시태그 전략 재편 (발견용 우선)
- 타겟 독자 "일반 대중 + 언론인" 명확화
- 본문 범위 140~180자 유지
...
- [ ] HOOK FORMULA 10개 모두 프롬프트에 포함
- [ ] TARGET AUDIENCE 명시
- [ ] ENGAGEMENT BAIT 3가지 장치 반영
- [ ] HASHTAG STRATEGY 순서 지정 (발견용 → 주제 → 브랜드)
- [ ] `#ANDCenter` 단독 사용 금지
- [ ] 예시 4개 훅 유형 분산 (인용/장면/비교/숫자)
- [ ] 본문 140~180자 범위 유지
- [ ] URL·해시태그 순서 고정
